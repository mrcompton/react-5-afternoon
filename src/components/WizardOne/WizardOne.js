...
//copy these items from redux state to local props
function mapStateToProps(reduxState){
    const { loanType, propertyType } = reduxState;
...
//run these functions and pass them back to redux store
const mapDipatch = {
    updateLoanType,
    updatePropertyType
}
...
export default connect(mapStateToProps,mapDipatch)(WizardOne); 